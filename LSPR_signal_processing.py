#   The LSPR Signal Processing Platform is a program that analyzes data obtained from LSPR-based biosensors
#   Copyright (C) 2023  Felipe Moreira Fernandes Teixeira
...
def folder_and_inputs():
  ...
  inputs = pd.read_csv('C:/PATH/analysis_parameters.csv', sep = ';')
